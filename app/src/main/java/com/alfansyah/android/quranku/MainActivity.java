package com.alfansyah.android.quranku;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtCari = findViewById(R.id.tvCari);
        ...
        //init data saat pertama buka app
        settings = getSharedPreferences("Quranku",0);
    ...
    private void insertFromFile(Context context, int resourceId){
        try {
            ...
            onAfterLoadingFirst();
            txtCari.setText("Gagal Memasukkan Quran");
            e.printStackTrace();
        }
    }
